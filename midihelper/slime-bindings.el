...
(defun toggle-metronome ()
  (interactive)
  (slime-interactive-eval "(global-ctrl #'toggle-metronome)"))
(global-set-key (kbd "M-m 0") 'toggle-metronome)

(defun midi-loop-cycle ()
  (interactive)
  (slime-interactive-eval "(calispel:! midihelper:*reader-ochan* (loop-ctrl #'loop-cycle))"))
(global-set-key (kbd "M-SPC") 'midi-loop-cycle)

(defun loop-play ()
  (interactive)
  (slime-interactive-eval "(calispel:! midihelper:*reader-ochan* (loop-ctrl #'loop-play))"))
(defun loop-play-push-extend ()
  (interactive)
  (slime-interactive-eval "(calispel:! midihelper:*reader-ochan* (loop-ctrl #'loop-push-extend))"))
(defun loop-stop ()
  (interactive)
  (slime-interactive-eval "(calispel:! midihelper:*reader-ochan* (loop-ctrl #'loop-stop))"))
(defun loop-erase ()
  (interactive)
  (slime-interactive-eval "(calispel:! midihelper:*reader-ochan* (loop-ctrl #'loop-erase))"))
(defun loop-overwrite ()
  (interactive)
  (slime-interactive-eval "(calispel:! midihelper:*reader-ochan* (loop-ctrl #'loop-overwrite))"))
(defun loop-overdub ()
  (interactive)
  (slime-interactive-eval "(calispel:! midihelper:*reader-ochan* (loop-ctrl #'loop-overdub))"))
